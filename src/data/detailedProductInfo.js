...
export const detailedProductInfo = {
  ...
  12: { // Rayhonli olma sharbati / Apple Basil Seed Juice Drink | 300mL
  ...
  13: { // Rayhonli ananas sharbati / Pineapple Basil Seed Juice Drink | 300mL
    variants: [{ volume: '300 mL', packaging: { dimensions: [225, 220, 271], unit: 'mm' } }],
  ...
  14: { // Rayhonli anor sharbati / Pomegranate Basil Seed Juice Drink | 300mL
    variants: [{ volume: '300 mL', packaging: { dimensions: [225, 220, 271], unit: 'mm' } }],
  ...
  15: { // Rayhonli shaftoli sharbati / Peach Basil Seed Juice Drink | 300mL
    variants: [{ volume: '300 mL', packaging: { dimensions: [225, 220, 271], unit: 'mm' } }],
